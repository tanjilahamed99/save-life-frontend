...
export default function ShopPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-6 bg-white -z-50">
      ...
      <div className="flex flex-col-reverse lg:flex-row gap-8 mt-6">
        ...
        <div className="lg:w-3/4">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
            <h1 className="text-2xl font-bold">All medicijnen kopen</h1>

            <div className="flex items-center md:space-x-4 mt-4 md:mt-0">
          ...
          <h2 className="text-xl font-bold mb-6">All medicijnen kopen</h2>
          ...
          {currentProducts.length === 0 ? (
            ...
            <div className="space-y-6">
              {currentProducts.map((product) => (
                <div
                  key={product.id}
                  className="flex border flex-col md:flex-row rounded-lg overflow-hidden">
                  <div className="md:w-1/3 bg-teal-50">
                    <div className="relative h-full">
                      <Image
                        ...
                        height={200}
                        width={200}
                        className="object-contain w-[90%] mx-auto md:w-full p-4 h-full"
                      />
                    </div>
                  </div>
                  <div className="md:w-2/3 p-4 flex flex-col">
                    ...
                    <div className="flex items-baseline mb-4">
                      ...
                      <span className="text-sm text-gray-600 ml-1">incl</span>
                    </div>
