    ...
    <div className="">
      <div className="bg-white rounded-lg shadow-sm p-6">
        <h2 className="text-xl font-bold mb-6">
          {formData.createTicket ? "Create new ticket" : "Send us a message"}
        </h2>
        ...
        {submitSuccess ? (
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-6">
              <div className="flex items-center">
                ...
                <label htmlFor="createTicket" className="ml-2 block text-sm text-gray-700">
                  Create a ticket instead of sending an email
                </label>
              </div>
              <p className="text-xs text-gray-500 mt-1 ml-6">
                A ticket allows you to track the progress of your inquiry and receive updates in your dashboard.
              </p>
            </div>
            ...
            <div className="flex justify-center">
              ...
              >
                {isSubmitting ? "Sending..." : formData.createTicket ? "Create ticket" : "Send message"}
              </button>
            </div>
          </form>
        )}
