...
export default function TicketDetailPage() {
  ...
  <Breadcrumb
    items={[
      ...
      {
        label: `Ticket #${id.substring(id.length - 6)}`,
            ...
            {ticket.responses.map((response, index) => (
              <div
                ...
                className={`p-4 rounded-lg ${
                  response.isAdmin ? "bg-teal-50 ml-4" : "bg-gray-50 mr-4"
                }`}
              >
                <div className="flex justify-between items-start mb-2">
                  <div className="font-medium">
                    {response.isAdmin ? "Support Team" : user?.name}
                  </div>
                  <div className="text-xs text-gray-500">
          ...
          <form onSubmit={handleSubmitResponse}>
            ...
            <div className="flex justify-between">
              ...
              <button
                ...
                disabled={
                  submitting || !newResponse.trim() || ticket.status === "closed"
                }
              >
      ...
      {ticket.status === "closed" && (
        <div className="mt-6 p-4 bg-gray-50 rounded-lg text-center">
          <p className="text-gray-700">
            This ticket is closed. You can no longer add responses.
          </p>
          <button
