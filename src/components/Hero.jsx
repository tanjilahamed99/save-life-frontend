        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <div className="w-full md:w-1/2 space-y-6">
            {/* <div className="inline-block px-4 py-2 bg-teal-100 text-teal-800 rounded-full text-sm font-medium mb-2">
              Betrouwbare Online Apotheek
            </div> */}

            <h2 className="text-3xl lg:text-4xl font-bold text-gray-800 mb-6 leading-tight">
              Medicijnen kopen zonder recept
            </h2>

            <div className="text-gray-700 space-y-4">
              <p className="lg:text-lg">
                Bij onze online apotheek staat betrouwbaarheid en discretie
                centraal. Wij begrijpen dat de aankoop van medicijnen een
                persoonlijke en vertrouwelijke aangelegenheid is.
              </p>
              <p>
                Daarom garanderen wij een snelle en discrete verwerking van elke
                bestelling. Jouw privacy en veiligheid zijn onze topprioriteit.
              </p>
              <p>
                Wij zorgen ervoor dat je bestelling met de grootste zorg wordt
                behandeld en zo snel mogelijk bij je wordt geleverd, zodat je
                zonder onnodige vertraging over je medicatie kunt beschikken.
              </p>
            </div>
