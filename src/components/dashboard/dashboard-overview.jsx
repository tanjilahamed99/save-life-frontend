...
export default function DashboardOverview() {
  ...
  const dashboardLinks = [
    ...
    {
      title: "Wallet",
      description: "Manage your balance and deposits",
      icon: Wallet,
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="mt-2 text-teal-100">
              Manage your orders, account, and more all from one central place
            </p>
          </div>
        ...
        <div className="p-5 sm:p-6 border-b border-gray-100 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            ...
            <p className="text-sm text-gray-600">
              View and manage your most recent purchases
            </p>
          </div>
          <Link
            href="/dashboard/orders"
        ...
        {loading ? (
          ...
          <div className="p-12 text-center">
            ...
            <p className="text-gray-600 max-w-md mx-auto mb-6">
              You have not placed any orders yet. Start shopping to make your
              first purchase.
            </p>
            <Link
              href="/shop"
